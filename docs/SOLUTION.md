...
In short: four systems — Intron Sahara, AssemblyAI Universal-3.5 Pro, Gemini 3.5 Transcribe, and
Gemini 3.8 Flash as a generalist control — evaluated on a frozen, pre-registered sample of AfriSwitch
under the corpus paper's own protocol, with the confidence intervals, paired significance tests and
